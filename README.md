# Мой репозиторий по прохождению курса CKA (ниже README официального репозитория)
В папке Days пишу выполненные тестовые задания

# Certified Kubernetes Administrator(CKA) 2024/2025
